...
class CustomChatCompletionMessageToolCallParam(
    ChatCompletionMessageToolCallParam, total=False
):
    predicted_tool_execution_time_seconds: Annotated[
        float, Field(ge=0, allow_inf_nan=False)
    ]
    """The model's predicted execution time for this tool call, in seconds."""
...
class CustomChatCompletionMessageParam(TypedDict, total=False):
    ...
    tool_exec_time: Annotated[float, Field(ge=0, allow_inf_nan=False)]
    """Observed execution time of the tool call, in seconds."""
...
def _parse_chat_message_content(
    ...
    tool_exec_time = message.get("tool_exec_time")
    ...
    for result_msg in result:
        if role == "assistant":
            ...
            if tool_exec_time is not None:
                result_msg["tool_exec_time"] = tool_exec_time
